        ...
        <div class="content">
            ...
            <div class="page-topbar">
                <div class="page-topbar-left">
                    <h2><i class="fas fa-folder-pen" style="color:var(--verde);"></i> Editar ficha</h2>
                    <p>Actualiza la información de la ficha <?= htmlspecialchars($ficha["numero_ficha"]) ?>.</p>
                </div>
            ...
            <?php if(isset($_GET["mensaje"]) && $_GET["mensaje"] === "error"): ?>
                <div class="alerta alerta-danger" id="alertaError">
                    <i class="fas fa-circle-xmark"></i>
                    No fue posible actualizar la ficha. Intenta nuevamente.
                    <button class="alerta-close" onclick="document.getElementById('alertaError').remove()">
            ...
            <div class="form-card">
                ...
                <div class="form-card-header">
                    ...
                    <div>
                        ...
                        <small>Modifica los datos necesarios y guarda los cambios</small>
                    </div>
        ...
        <span class="select-arrow">▼</span>
                        ...
                        <div style="display:grid;grid-template-columns:1fr;">
                            <div class="section-sep">
                                <i class="fas fa-sliders"></i> Configuración de la ficha
                            </div>
                        </div>

                        <!-- Fila 2: jornada + nivel + cupo -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <select name="jornada" required>
                                        <?php
                                            $jornadas = ["Mañana","Tarde","Noche","Mixta","Virtual"];
                                            foreach($jornadas as $j):
                                        ?>
                                            <option value="<?= $j ?>" <?= ($ficha["jornada"] === $j) ? "selected" : "" ?>>
                                                <?= $j ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <select name="nivel_formacion">
                                        ...
                                        <?php
                                            $niveles = ["Técnico","Tecnólogo","Especialización tecnológica","Complementario"];
                                            foreach($niveles as $n):
                                        ?>
                                            <option value="<?= $n ?>" <?= ($ficha["nivel_formacion"] === $n) ? "selected" : "" ?>>
                                                <?= $n ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="number" name="cupo_maximo"
                                        value="<?= htmlspecialchars($ficha["cupo_maximo"] ?? 35) ?>"
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="date" name="fecha_inicio"
                                        value="<?= htmlspecialchars($ficha["fecha_inicio"] ?? "") ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="date" name="fecha_fin"
                                        value="<?= htmlspecialchars($ficha["fecha_fin"] ?? "") ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-wrap">
                                    ...
                                    <input type="text" name="instructor"
                                        value="<?= htmlspecialchars($ficha["instructor"] ?? "") ?>"
